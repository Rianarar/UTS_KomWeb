...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl pozsition-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown"><?php echo $row["title_que"];?></h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item text-white active"><a><?php echo $row["desc_que"];?></a></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="margin-top: -75px;">
                    <div class="col-md-8">
                        <h1><?php echo $row["question"];?></h1>
                        <div class="wow fadeInUp" data-wow-delay="0.2s" style="margin-top: 25px;">
                            <form action="insert.php" method="post">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="name" placeholder="Your Name" name="name">
                                            <label for="name"><?php echo $row["yname"];?></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="email" class="form-control" id="email" placeholder="Your Email" name="eml">
                                            <label for="email"><?php echo $row["yemail"];?></label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a message here" id="message" name="msg" style="height: 150px"></textarea>
                                            <label for="message"><?php echo $row["ymsg"];?></label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" type="submit"><?php echo $row["send"];?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
